...
io_subsystem_core1 #(
    ...
    .ADDR_DISP_7SEG      (`ADDR_DISP_7SEG),
    .ADDR_FIFO_DATA      (`ADDR_FIFO_DATA),
    .ADDR_FIFO_EMPTY     (`ADDR_FIFO_EMPTY),    
    .ADDR_CORE_ID        (`ADDR_CORE_ID)
) io_subsystem_core1 (
    .clk                 (clk),
    .rst_n               (rst_n),
    ...
    .i_mmio_rden         (xbar2mmio_rden),
    .i_mmio_mask         (xbar2mmio_mask),
    .o_mmio_data         (mmio2xbar_data),
    
    .o_afifo_rdreq       (o_afifo_rdreq),       
    .i_afifo_q           (i_afifo_q),   
    .i_afifo_rdempty     (i_afifo_rdempty),           
