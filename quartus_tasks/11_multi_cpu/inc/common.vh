...
`define LSU_ADDR_SEL_WIDTH 1

`define LSU_ADDR_SEL_I 1'b0
`define LSU_ADDR_SEL_S 1'b1


`define PC_ADD_SEL_WIDTH 2

`define PC_ADD_SEL_JAL  2'b00
`define PC_ADD_SEL_BRAN 2'b01
`define PC_ADD_SEL_JALR 2'b11
